...
m = AANet(3, 2, inner_channel=128).to('cuda')
total_params4 = sum(p.numel() for p in m.parameters() if p.requires_grad)
print(f"Total trainable parameters: {total_params4}")