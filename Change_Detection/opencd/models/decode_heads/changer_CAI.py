...
class CrossAttention(nn.Module):
    def __init__(self,
        ...
        self.norm1 = build_norm_layer(self.norm_cfg, in_dims)[1]
        self.norm2 = build_norm_layer(self.norm_cfg, in_dims)[1]
    ...
    def forward(self, x1_, x2_):
        ...
        return self.norm1(out1)+x1_,self.norm2(out2)+x2_
...
class Changer_CAI(BaseDecodeHead):
    """The Head of Changer.
    ...
    def CAI(self,x1,x2,reference_area1,reference_area2):
        ...
        out1_content = F.interpolate(out1_content, size=(h, w), mode='bilinear',
                                         align_corners=False)
        out1_content = x1+self.norm1(out1_content)
        ...
        out2_content = F.interpolate(out2_content, size=(h, w), mode='bilinear',
                                     align_corners=False)
        out2_content = x2 + self.norm2(out2_content)
