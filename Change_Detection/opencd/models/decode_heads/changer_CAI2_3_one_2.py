...
class Changer_CAI2_3_one_2(BaseDecodeHead):
    """The Head of Changer.
    ...
    def CAI(self,x1,x2,reference_area1,reference_area2,query_bias1,query_bias2):
        b, c, h, w = x1.shape
    ...
    def forward(self, inputs):
        ...
        out1,out2=self.CAI(out1,out2,self.reference_area1.weight,self.reference_area2.weight,query_bias1_1,query_bias2_2)
